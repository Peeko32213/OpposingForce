...
import com.barl_inc.opposing_force.client.models.entity.WhizzModel;
...
public class WhizzRenderer extends MobRenderer<Whizz, WhizzModel> {
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(@NotNull Whizz entity) {
        return TEXTURE;
    }

    @Override
    protected @Nullable RenderType getRenderType(@NotNull Whizz entity, boolean bodyVisible, boolean translucent, boolean glowing) {
