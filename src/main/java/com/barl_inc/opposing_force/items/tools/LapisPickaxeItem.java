...
public class LapisPickaxeItem extends ConfigurablePickaxetem {

    public LapisPickaxeItem(Properties properties) {
        super(OPToolDefinitions.LAPIS, 1, -2.8F, properties);
    }
