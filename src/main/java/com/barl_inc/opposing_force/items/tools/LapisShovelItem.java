...
public class LapisShovelItem extends ConfigurableShovelItem {

    public LapisShovelItem(Properties properties) {
        super(OPToolDefinitions.LAPIS, 1.5F, -3.0F, properties);
    }
