package com.barl_inc.opposing_force.entity.ai.navigation;
...
public class SkyvernPathNavigation extends FlyingPathNavigation {

    public SkyvernPathNavigation(Mob mob, Level level) {
        super(mob, level);
    }
