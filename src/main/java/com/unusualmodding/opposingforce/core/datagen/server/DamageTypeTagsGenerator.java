...
import static com.unusualmodding.opposingforce.core.registry.OPDamageTypes.ELECTRIFIED;
import static com.unusualmodding.opposingforce.core.registry.OPDamageTypes.TOMAHAWK;
...
public class DamageTypeTagsGenerator extends TagsProvider<DamageType> {
    ...
    public DamageTypeTagsGenerator(PackOutput output, CompletableFuture<HolderLookup.Provider> future, ExistingFileHelper helper) {
        super(output, Registries.DAMAGE_TYPE, future, OpposingForce.MODID, helper);
    }
    ...
    private static TagKey<DamageType> create(String name) {
        return TagKey.create(Registries.DAMAGE_TYPE, OpposingForce.prefix(name));
    }
}
