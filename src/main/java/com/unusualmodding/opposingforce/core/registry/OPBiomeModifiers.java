...
public class OPBiomeModifiers {
    ...
    public static void bootstrap(BootstapContext<BiomeModifier> context) {
        ...
        addSpawn(context, "hopper", OPTags.WITH_DEFAULT_MONSTER_SPAWNS, new MobSpawnSettings.SpawnerData(OPEntities.HOPPER.get(), 50, 3, 5));
    ...
    private static void register(BootstapContext<BiomeModifier> context, String name, Supplier<? extends BiomeModifier> modifier) {
        context.register(ResourceKey.create(ForgeRegistries.Keys.BIOME_MODIFIERS, new ResourceLocation(OpposingForce.MODID, name)), modifier.get());
    }
