...
import com.unusualmodding.opposingforce.common.entity.util.DamageUtil;
import com.unusualmodding.opposingforce.interfaces.CreeperExtension;
...
public class LightningDamageC2SPacket {
    private final int targetId, senderId;
    private final float damage;
    private final Vec3 knockback;

    public LightningDamageC2SPacket(int senderId, int targetId, float damage, Vec3 knockback) {
    ...
    public LightningDamageC2SPacket(FriendlyByteBuf buf) {
