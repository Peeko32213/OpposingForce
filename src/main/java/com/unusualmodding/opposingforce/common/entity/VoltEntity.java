...
public class VoltEntity extends AbstractMonster implements GeoAnimatable, GeoEntity {
    ...
    public VoltEntity(EntityType<? extends Monster> pEntityType, Level pLevel) {
    ...
    protected <E extends VoltEntity> PlayState controller(final software.bernie.geckolib.core.animation.AnimationState<E> event) {
        {
