...
public class DicerEntity extends AbstractMonster implements GeoAnimatable, GeoEntity {
    private static final EntityDataAccessor<Boolean> SPOTTED = SynchedEntityData.defineId(DicerEntity.class, EntityDataSerializers.BOOLEAN);
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new DicerEntity.RambleMeleeAttackGoal(this,  1.8F, true));
    ...
    protected <E extends DicerEntity> PlayState controller(final software.bernie.geckolib.core.animation.AnimationState<E> event) {
    ...
    static class RambleMeleeAttackGoal extends Goal {
        ...
        protected final DicerEntity mob;
        ...
        public RambleMeleeAttackGoal(DicerEntity p_i1636_1_, double p_i1636_2_, boolean p_i1636_4_) {
            this.mob = p_i1636_1_;
