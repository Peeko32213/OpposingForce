...
public class SpindleEntity extends StatedAbstractMonster implements GeoAnimatable, GeoEntity {
    ...
    public SpindleEntity(EntityType<? extends AbstractMonster> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new SpindleEntity.SpindleMeleeAttackGoal(this,  1.8F, true));
    ...
    static class SpindleMeleeAttackGoal extends Goal {
        ...
        protected final SpindleEntity mob;
        ...
        public SpindleMeleeAttackGoal(SpindleEntity p_i1636_1_, double p_i1636_2_, boolean p_i1636_4_) {
            this.mob = p_i1636_1_;
