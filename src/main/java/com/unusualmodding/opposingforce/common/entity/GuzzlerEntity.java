...
import com.unusualmodding.opposingforce.common.entity.util.StatedAbstractMonster;
...
public class GuzzlerEntity extends StatedAbstractMonster implements GeoAnimatable, GeoEntity {
    ...
    public GuzzlerEntity(EntityType<? extends StatedAbstractMonster> pEntityType, Level pLevel) {
    ...
    public void tick() {
        ...
        if (this.getTarget() != null && getShootCooldown() == 0) {
            FireSlimeEntity pole = OPEntities.FIRE_SLIME.get().create(level());
    ...
    public static class GuzzlerShootingGoal extends Goal {
        private final GuzzlerEntity entity;
        ...
        public GuzzlerShootingGoal(GuzzlerEntity mob, double moveSpeedAmpIn, int attackCooldownIn, float maxAttackDistanceIn) {
            this.entity = mob;
