...
public class HopperEntity extends AbstractMonster implements GeoAnimatable, GeoEntity {
    ...
    public HopperEntity(EntityType<? extends Monster> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.moveControl = new HopperEntity.SlimeMoveControl(this);
    }
    ...
    protected void registerGoals() {
        this.goalSelector.addGoal(1, new HopperEntity.SlimeFloatGoal(this));
        this.goalSelector.addGoal(2, new HopperEntity.SlimeAttackGoal(this));
        this.goalSelector.addGoal(1, new HopperEntity.SlimeRandomDirectionGoal(this));
        this.goalSelector.addGoal(5, new HopperEntity.SlimeKeepOnJumpingGoal(this));
    ...
    public static <T extends Mob> boolean canFirstTierSpawn(EntityType<HopperEntity> entityType, ServerLevelAccessor iServerWorld, MobSpawnType reason, BlockPos pos, RandomSource random) {
    ...
    static class SlimeAttackGoal extends Goal {
        private final HopperEntity slime;
        private int growTiredTimer;

        public SlimeAttackGoal(HopperEntity pSlime) {
            this.slime = pSlime;
        ...
        public boolean canUse() {
            ...
            if (livingentity == null) {
                ...
                return !this.slime.canAttack(livingentity) ? false : this.slime.getMoveControl() instanceof HopperEntity.SlimeMoveControl;
            }
        }
        ...
        public void tick() {
            ...
            if (movecontrol instanceof HopperEntity.SlimeMoveControl slime$slimemovecontrol) {
    ...
    static class SlimeFloatGoal extends Goal {
        ...
        public SlimeFloatGoal(HopperEntity pSlime) {
            this.slime = pSlime;
         ...
         */
        public boolean canUse() {
            return (this.slime.isInWater() || this.slime.isInLava()) && this.slime.getMoveControl() instanceof HopperEntity.SlimeMoveControl;
        }
    ...
    static class SlimeKeepOnJumpingGoal extends Goal {
        ...
        public SlimeKeepOnJumpingGoal(HopperEntity pSlime) {
            this.slime = pSlime;
            this.setFlags(EnumSet.of(Goal.Flag.JUMP, Goal.Flag.MOVE));
        }
    ...
    static class SlimeMoveControl extends MoveControl {
        ...
        public SlimeMoveControl(HopperEntity pSlime) {
            super(pSlime);
            this.slime = pSlime;
    ...
    static class SlimeRandomDirectionGoal extends Goal {
        ...
        public SlimeRandomDirectionGoal(HopperEntity pSlime) {
            this.slime = pSlime;
            this.setFlags(EnumSet.of(Goal.Flag.LOOK));
        }
         ...
         */
        public boolean canUse() {
            return this.slime.getTarget() == null && (this.slime.onGround() || this.slime.isInWater() || this.slime.isInLava() || this.slime.hasEffect(MobEffects.LEVITATION)) && this.slime.getMoveControl() instanceof HopperEntity.SlimeMoveControl;
        }
    ...
    protected <E extends HopperEntity> PlayState controller(final software.bernie.geckolib.core.animation.AnimationState<E> event) {
