...
public class OPGlowingEyeLayer<T extends LivingEntity & GeoEntity> extends GeoRenderLayer<T> {
    ...
    public void render(PoseStack poseStack, T animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
        RenderType eyes = RenderType.eyes(new ResourceLocation(OpposingForce.MODID, "textures/entity/eyes/" + loc + ".png"));
        VertexConsumer vertexConsumer = bufferSource.getBuffer(eyes);
        ResourceLocation modelLoc = new ResourceLocation(OpposingForce.MODID, "geo/entity/" + loc + ".geo.json");
