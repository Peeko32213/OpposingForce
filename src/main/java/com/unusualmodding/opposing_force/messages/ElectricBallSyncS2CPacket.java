package com.unusualmodding.opposing_force.messages;

import com.unusualmodding.opposing_force.client.particles.LightningBallParticleType;
import com.unusualmodding.opposing_force.client.particles.LightningTarget;
...
public class ElectricBallSyncS2CPacket {
    ...
    public ElectricBallSyncS2CPacket(float blockX, float blockY, float blockZ, float attackX, float attackY, float attackZ, int senderId, int range, int sections, float size, float parallelNoise, float spreadFactor, float branchInitiationFactor, float branchContinuationFactor, float closeness, Vector4f color, LightningTarget target) {
    ...
    public static class Builder {
        ...
        public ElectricBallSyncS2CPacket build() {
            return new ElectricBallSyncS2CPacket(blockX, blockY, blockZ, attackX, attackY, attackZ, senderId, range, sections, size, parallelNoise, spreadFactor, branchInitiationFactor, branchContinuationFactor, closeness, color, new LightningTarget(targetType, entityId, targetPos, chainTargets));
        }
    }
}
