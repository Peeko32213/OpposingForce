...
public class EmeraldAxeItem extends AxeItem implements EmeraldTool {
    private Multimap<Attribute, AttributeModifier> attributes;

    public EmeraldAxeItem(Tier tier, float attackDamageModifier, float attackSpeedModifier, Properties properties) {
