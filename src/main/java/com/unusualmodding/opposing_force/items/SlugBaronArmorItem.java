...
public class SlugBaronArmorItem extends ArmorItem {

    public SlugBaronArmorItem(Type type, Properties properties) {
        super(OPArmorMaterials.SLUG_BARON, type, properties);
    }
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
        if (slot.equals(EquipmentSlot.LEGS)) return OpposingForce.MOD_ID + ":textures/models/armor/slug_baron_armor_layer_2.png";
        else return OpposingForce.MOD_ID + ":textures/models/armor/slug_baron_armor_layer_1.png";
    }
}
