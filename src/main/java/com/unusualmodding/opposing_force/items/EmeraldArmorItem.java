...
public class EmeraldArmorItem extends ArmorItem {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
        if (slot == EquipmentSlot.HEAD) {
            return OpposingForce.MOD_ID + ":textures/models/armor/emerald_layer_3.png";
        }
        if (slot == EquipmentSlot.LEGS) {
            return OpposingForce.MOD_ID + ":textures/models/armor/emerald_layer_1.png";
        }
        if (slot == EquipmentSlot.FEET) {
            return OpposingForce.MOD_ID + ":textures/models/armor/emerald_layer_4.png";
        }
        else {
            return OpposingForce.MOD_ID + ":textures/models/armor/emerald_layer_2.png";
        }
    }
}
