...
public class OPRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(BUILDING_BLOCKS, OPBlocks.TREMBLING_SLAB.get(), 3).define('T', OPBlocks.TREMBLING_BLOCK.get()).pattern("TTT").unlockedBy("has_trembler_shell", has(OPBlocks.TREMBLER_SHELL.get())).save(consumer);
        ShapedRecipeBuilder.shaped(BUILDING_BLOCKS, OPBlocks.CHISELED_TREMBLING_BLOCK.get(), 1).define('T', OPBlocks.TREMBLING_SLAB.get()).pattern("T").pattern("T").unlockedBy("has_trembler_shell", has(OPBlocks.TREMBLER_SHELL.get())).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(BUILDING_BLOCKS, OPBlocks.VILE_STONE.get(), 8).define('E', SLUG_EGGS.get()).define('S', Blocks.STONE).pattern("SSS").pattern("SES").pattern("SSS").unlockedBy("has_slug_eggs", has(SLUG_EGGS.get())).save(consumer);
        ShapedRecipeBuilder.shaped(BUILDING_BLOCKS, OPBlocks.VILE_STONE_SLAB.get(), 3).define('V', OPBlocks.VILE_STONE.get()).pattern("VVV").unlockedBy("has_slug_eggs", has(SLUG_EGGS.get())).save(consumer);
        ShapedRecipeBuilder.shaped(BUILDING_BLOCKS, OPBlocks.VILE_STONE_STAIRS.get(), 4).define('V', OPBlocks.VILE_STONE.get()).pattern("V  ").pattern("VV ").pattern("VVV").unlockedBy("has_slug_eggs", has(SLUG_EGGS.get())).save(consumer);

        ShapedRecipeBuilder.shaped(BUILDING_BLOCKS, OPBlocks.VILE_COBBLESTONE.get(), 8).define('E', SLUG_EGGS.get()).define('S', Blocks.COBBLESTONE).pattern("SSS").pattern("SES").pattern("SSS").unlockedBy("has_slug_eggs", has(SLUG_EGGS.get())).save(consumer);
        ShapedRecipeBuilder.shaped(BUILDING_BLOCKS, OPBlocks.VILE_COBBLESTONE_SLAB.get(), 3).define('V', OPBlocks.VILE_COBBLESTONE.get()).pattern("VVV").unlockedBy("has_slug_eggs", has(SLUG_EGGS.get())).save(consumer);
        ShapedRecipeBuilder.shaped(BUILDING_BLOCKS, OPBlocks.VILE_COBBLESTONE_STAIRS.get(), 4).define('V', OPBlocks.VILE_COBBLESTONE.get()).pattern("V  ").pattern("VV ").pattern("VVV").unlockedBy("has_slug_eggs", has(SLUG_EGGS.get())).save(consumer);
        ShapedRecipeBuilder.shaped(BUILDING_BLOCKS, OPBlocks.VILE_COBBLESTONE_WALL.get(), 6).define('V', OPBlocks.VILE_COBBLESTONE.get()).pattern("VVV").pattern("VVV").unlockedBy("has_slug_eggs", has(SLUG_EGGS.get())).save(consumer);

        ShapedRecipeBuilder.shaped(BUILDING_BLOCKS, OPBlocks.VILE_STONE_BRICKS.get(), 4).define('V', OPBlocks.VILE_STONE.get()).pattern("VV").pattern("VV").unlockedBy("has_slug_eggs", has(SLUG_EGGS.get())).save(consumer);
        ShapedRecipeBuilder.shaped(BUILDING_BLOCKS, OPBlocks.VILE_STONE_BRICK_SLAB.get(), 3).define('V', OPBlocks.VILE_STONE_BRICKS.get()).pattern("VVV").unlockedBy("has_slug_eggs", has(SLUG_EGGS.get())).save(consumer);
        ShapedRecipeBuilder.shaped(BUILDING_BLOCKS, OPBlocks.VILE_STONE_BRICK_STAIRS.get(), 4).define('V', OPBlocks.VILE_STONE_BRICKS.get()).pattern("V  ").pattern("VV ").pattern("VVV").unlockedBy("has_slug_eggs", has(SLUG_EGGS.get())).save(consumer);
        ShapedRecipeBuilder.shaped(BUILDING_BLOCKS, OPBlocks.VILE_STONE_BRICK_WALL.get(), 6).define('V', OPBlocks.VILE_STONE_BRICKS.get()).pattern("VVV").pattern("VVV").unlockedBy("has_slug_eggs", has(SLUG_EGGS.get())).save(consumer);
        ShapedRecipeBuilder.shaped(BUILDING_BLOCKS, OPBlocks.CHISELED_VILE_STONE_BRICKS.get(), 2).define('V', OPBlocks.VILE_STONE_BRICK_SLAB.get()).pattern("V").pattern("V").unlockedBy("has_slug_eggs", has(SLUG_EGGS.get())).save(consumer);
