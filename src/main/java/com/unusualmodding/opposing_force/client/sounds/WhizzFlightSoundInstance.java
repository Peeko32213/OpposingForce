...
@OnlyIn(Dist.CLIENT)
public class WhizzFlightSoundInstance extends AbstractTickableSoundInstance {

    protected final WhizzEntity entity;

    public WhizzFlightSoundInstance(WhizzEntity entity) {
        super(OPSounds.WHIZZ_FLY.get(), SoundSource.NEUTRAL, SoundInstance.createUnseededRandom());
        this.entity = entity;
