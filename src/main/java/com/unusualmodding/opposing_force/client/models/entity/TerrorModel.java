...
public class TerrorModel<T extends TerrorEntity> extends HierarchicalModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition BackBody = Body.addOrReplaceChild("BackBody", CubeListBuilder.create().texOffs(25, 38).addBox(-1.0F, -0.05F, 0.0F, 3.0F, 4.0F, 17.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -2.0F, 6.0F));
		...
		PartDefinition Tail = BackBody.addOrReplaceChild("Tail", CubeListBuilder.create().texOffs(0, 51).addBox(0.0F, -2.0F, 0.0F, 1.0F, 7.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 2.0F, 12.0F));
