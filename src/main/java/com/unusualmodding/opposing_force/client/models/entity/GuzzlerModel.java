...
public class GuzzlerModel extends HierarchicalModel<Guzzler> {
	...
	public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition body = root.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0).addBox(-19.5F, -30.0F, -7.0F, 39.0F, 30.0F, 21.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 0).mirror().addBox(-28.5F, -30.0F, 13.0F, 9.0F, 8.0F, 0.0F, new CubeDeformation(0.0025F)).mirror(false), PartPose.offset(0.0F, -6.0F, 0.0F));
        ...
        PartDefinition jaw = body.addOrReplaceChild("jaw", CubeListBuilder.create().texOffs(105, 32).addBox(-1.5F, -5.075F, -32.0F, 5.0F, 5.0F, 33.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 77).addBox(-18.5F, -3.0F, -21.0F, 39.0F, 5.0F, 21.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition left_foot = root.addOrReplaceChild("left_foot", CubeListBuilder.create().texOffs(48, 103).addBox(-4.0F, -6.0F, -3.0F, 9.0F, 10.0F, 15.0F, new CubeDeformation(0.0F))
                .texOffs(0, 105).addBox(-4.0F, 4.0F, 7.0F, 9.0F, 4.0F, 5.0F, new CubeDeformation(0.0F))
                .texOffs(30, 107).addBox(-4.0F, 7.0F, 3.0F, 9.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(17.0F, -8.0F, -5.0F));

        PartDefinition right_foot = root.addOrReplaceChild("right_foot", CubeListBuilder.create().texOffs(48, 103).mirror().addBox(-5.0F, -6.0F, -3.0F, 9.0F, 10.0F, 15.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(0, 105).mirror().addBox(-5.0F, 4.0F, 7.0F, 9.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(30, 107).mirror().addBox(-5.0F, 7.0F, 3.0F, 9.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-17.0F, -8.0F, -5.0F));
