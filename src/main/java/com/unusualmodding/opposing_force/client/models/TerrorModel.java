...
public class TerrorModel extends GeoModel<TerrorEntity>
{
    ...
    {
        return new ResourceLocation(OpposingForce.MOD_ID, "geo/entity/terror.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(TerrorEntity object)
    {
        return new ResourceLocation(OpposingForce.MOD_ID, "textures/entity/terror.png");
    }

    @Override
    public ResourceLocation getAnimationResource(TerrorEntity object)
    {
        return new ResourceLocation(OpposingForce.MOD_ID, "animations/terror.animation.json");
    }
