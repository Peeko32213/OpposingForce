...
public class DeepwovenArmorModel extends HumanoidModel {
	...
	public static LayerDefinition createArmorLayer() {
		...
		body.addOrReplaceChild("chestplate", CubeListBuilder.create()
				...
				.texOffs(32, 40).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.54F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		rightArm.addOrReplaceChild("right_sleeve", CubeListBuilder.create()
				...
				.texOffs(0, 29).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.45F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		leftArm.addOrReplaceChild("left_sleeve", CubeListBuilder.create()
				...
				.texOffs(0, 29).mirror().addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.45F)).mirror(false), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		leftLeg.addOrReplaceChild("left_pants", CubeListBuilder.create()
				...
				.texOffs(42, 7).addBox(-1.85F, 9.0F, -2.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.5F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		rightLeg.addOrReplaceChild("right_pants", CubeListBuilder.create()
				...
				.texOffs(42, 7).mirror().addBox(-2.1F, 9.0F, -2.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.5F)).mirror(false), PartPose.offset(0.0F, 0.0F, 0.0F));
