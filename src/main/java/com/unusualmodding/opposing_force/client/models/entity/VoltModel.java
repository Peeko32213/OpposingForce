...
public class VoltModel extends HierarchicalModel<Volt> {
	...
	public static LayerDefinition createBodyLayer(CubeDeformation deformation) {
        ...
        PartDefinition tail1 = root.addOrReplaceChild("tail1", CubeListBuilder.create().texOffs(60, 19).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 2.0F, 8.0F, new CubeDeformation(0.0F))
                .texOffs(60, 59).addBox(-1.0F, -6.0F, 4.0F, 2.0F, 6.0F, 3.0F, new CubeDeformation(0.01F))
                .texOffs(34, 41).addBox(0.0F, -10.0F, 2.0F, 0.0F, 9.0F, 13.0F, new CubeDeformation(0.0025F))
                .texOffs(62, 6).addBox(-1.0F, -6.0F, 7.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -16.0F, 0.0F));

        PartDefinition tail_2 = tail1.addOrReplaceChild("tail_2", CubeListBuilder.create().texOffs(22, 60).addBox(-1.0F, -1.0F, 0.0F, 2.0F, 16.0F, 2.0F, new CubeDeformation(0.01F)), PartPose.offset(0.0F, -5.0F, 11.0F));
        ...
        PartDefinition body = root.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 15).addBox(-7.5F, -4.0F, -11.5F, 15.0F, 1.0F, 15.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(34, 31).addBox(-5.5F, -3.025F, -10.5F, 11.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -16.0F, 0.0F));

        PartDefinition jowls = body.addOrReplaceChild("jowls", CubeListBuilder.create().texOffs(60, 15).addBox(-7.5F, 0.0F, -4.0F, 15.0F, 0.0F, 4.0F, new CubeDeformation(0.0025F)), PartPose.offset(0.0F, -3.0F, -11.5F));
        ...
        PartDefinition jaw = body.addOrReplaceChild("jaw", CubeListBuilder.create().texOffs(60, 53).addBox(-1.5F, -1.0F, -2.0F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, -9.5F));

        PartDefinition left_wing = body.addOrReplaceChild("left_wing", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(0.0F, 0.0F, -1.0F, 16.0F, 0.0F, 15.0F, new CubeDeformation(0.0025F)).mirror(false), PartPose.offset(7.5F, -3.0F, -10.5F));

        PartDefinition right_wing = body.addOrReplaceChild("right_wing", CubeListBuilder.create().texOffs(0, 0).addBox(-16.0F, 0.0F, -1.0F, 16.0F, 0.0F, 15.0F, new CubeDeformation(0.0025F)), PartPose.offset(-7.5F, -3.0F, -10.5F));
