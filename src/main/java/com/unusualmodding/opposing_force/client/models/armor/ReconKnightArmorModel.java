...
public class ReconKnightArmorModel extends HumanoidModel<LivingEntity> {
    ...
    public static LayerDefinition createArmorLayer() {
        ...
        body.addOrReplaceChild("chestplate", CubeListBuilder.create()
                ...
                .texOffs(40, 106).addBox(-4.0F, 9.0F, -2.5F, 8.0F, 3.0F, 5.0F, new CubeDeformation(0.6F))
                .texOffs(78, 68).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.5F)), PartPose.ZERO);

        body.addOrReplaceChild("cape", CubeListBuilder.create()
                .texOffs(40, 56).addBox(-7.0F, -1.0F, 0.0F, 14.0F, 21.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 3.0F));

        rightArm.addOrReplaceChild("right_pauldron", CubeListBuilder.create()
                .texOffs(98, 114).addBox(-4.05F, -2.0F, -2.5F, 5.0F, 4.0F, 5.0F, new CubeDeformation(0.5F))
                .texOffs(78, 84).addBox(-4.05F, -3.6F, -2.5F, 5.0F, 1.0F, 5.0F, new CubeDeformation(0.5F))
                .texOffs(102, 77).addBox(-4.05F, 5.0F, -2.5F, 5.0F, 3.0F, 5.0F, new CubeDeformation(0.5F))
                .texOffs(106, 58).addBox(-3.3F, -1.0F, -2.0F, 4.0F, 11.0F, 4.0F, new CubeDeformation(0.51F)), PartPose.ZERO);

        leftArm.addOrReplaceChild("left_pauldron", CubeListBuilder.create()
                .texOffs(106, 58).mirror().addBox(-0.7F, -1.0F, -2.0F, 4.0F, 11.0F, 4.0F, new CubeDeformation(0.51F)).mirror(false)
                .texOffs(102, 77).mirror().addBox(-0.95F, 5.0F, -2.5F, 5.0F, 3.0F, 5.0F, new CubeDeformation(0.5F)).mirror(false)
                .texOffs(78, 84).mirror().addBox(-0.95F, -3.6F, -2.5F, 5.0F, 1.0F, 5.0F, new CubeDeformation(0.5F)).mirror(false)
                .texOffs(98, 114).mirror().addBox(-0.95F, -2.0F, -2.5F, 5.0F, 4.0F, 5.0F, new CubeDeformation(0.5F)).mirror(false), PartPose.ZERO);

        leftLeg.addOrReplaceChild("left_legging", CubeListBuilder.create()
                .texOffs(112, 87).mirror().addBox(-2.0F, 0.0F, -2.0F, 4.0F, 11.0F, 4.0F, new CubeDeformation(0.51F)).mirror(false), PartPose.ZERO);

        leftLeg.addOrReplaceChild("left_boot", CubeListBuilder.create()
                .texOffs(61, 117).mirror().addBox(-2.0F, 10.0F, -2.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.61F)).mirror(false), PartPose.ZERO);

        rightLeg.addOrReplaceChild("right_legging", CubeListBuilder.create()
                .texOffs(82, 112).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 11.0F, 4.0F, new CubeDeformation(0.5F)), PartPose.ZERO);

        rightLeg.addOrReplaceChild("right_boot", CubeListBuilder.create()
                .texOffs(61, 117).addBox(-2.0F, 10.0F, -2.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.6F)), PartPose.ZERO);
