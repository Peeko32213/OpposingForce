...
import com.unusualmodding.opposing_force.entity.FrowzyEntity;
...
@OnlyIn(Dist.CLIENT)
public class FrowzyRenderer extends MobRenderer<FrowzyEntity, FrowzyModel<FrowzyEntity>> {
    ...
    @Override
    public ResourceLocation getTextureLocation(FrowzyEntity entity) {
        return TEXTURE;
    }

    @Override
    protected @Nullable RenderType getRenderType(FrowzyEntity entity, boolean bodyVisible, boolean translucent, boolean glowing) {
