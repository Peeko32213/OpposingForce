...
@OnlyIn(Dist.CLIENT)
public class DicerRenderer extends MobRenderer<DicerEntity, DicerModel<DicerEntity>> {
    ...
    @Override
    public ResourceLocation getTextureLocation(DicerEntity entity) {
        return TEXTURE;
    }

    @Override
    protected @Nullable RenderType getRenderType(DicerEntity entity, boolean bodyVisible, boolean translucent, boolean glowing) {
