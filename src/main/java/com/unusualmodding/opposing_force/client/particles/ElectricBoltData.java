...
public class ElectricBoltData {
    ...
    public ElectricBoltData(Vec3 start, Vec3 end) {
        this(BoltRenderInfo.DEFAULT, start, end, (int)Math.sqrt(start.distanceTo(end) * 100.0));
    }

    public ElectricBoltData(BoltRenderInfo info, Vec3 start, Vec3 end, int segments) {
    ...
    public ElectricBoltData count(int count) {
        this.count = count;
        return this;
    }

    public ElectricBoltData size(float size) {
        this.size = size;
        return this;
    }

    public ElectricBoltData spawn(SpawnFunction spawnFunction) {
        this.spawnFunction = spawnFunction;
        return this;
    }

    public ElectricBoltData fade(FadeFunction fadeFunction) {
        this.fadeFunction = fadeFunction;
        return this;
    }

    public ElectricBoltData lifespan(int lifespan) {
