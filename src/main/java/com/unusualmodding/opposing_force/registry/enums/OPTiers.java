...
public class OPTiers {
    ...
    public static class OPArmorMaterials {
        ...
        public static final ArmorMaterial LEAPING_LEGGINGS = new OPArmorMaterial("leaping_leggings", 34, new int[] {1, 1, 1, 1}, 8, OPSoundEvents.ARMOR_EQUIP_MOON_SHOES.get(), 0F, 0F, ()-> Ingredient.of(Tags.Items.GEMS_DIAMOND));
        public static final ArmorMaterial MOON_SHOES = new OPArmorMaterial("moon_shoes", 34, new int[] {1, 1, 1, 1}, 8, OPSoundEvents.ARMOR_EQUIP_MOON_SHOES.get(), 0F, 0F, ()-> Ingredient.of(Tags.Items.FEATHERS));
    ...
    public static class OPItemTiers {
        ...
        public static final Tier LASER = new OPItemTier(3, 1024, 8.0F, 4.0F, 9, () -> Ingredient.of(OPItems.DICER_LENS.get()));
        ...
        public static final Tier SAWBLADE = new OPItemTier(3, 1024, 10.0F, 3.0F, 10, () -> Ingredient.of(OPItems.TERROR_SAW.get()));
