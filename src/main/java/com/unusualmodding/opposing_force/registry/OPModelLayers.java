...
public class OPModelLayers {
    ...
    public static final ModelLayerLocation LADYBUG = main("ladybug");
    ...
    public static final ModelLayerLocation SKYVERN = main("skyvern");
    public static final ModelLayerLocation SKYVERN_BODY = main("skyvern_body");
    public static final ModelLayerLocation SKYVERN_TAIL = main("skyvern_tail");
    public static final ModelLayerLocation SKYVERN_HEAD = main("skyvern_head");
    ...
    public static final ModelLayerLocation LEAPING_LEGGINGS = main("leaping_leggings");
