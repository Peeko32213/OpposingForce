...
public class OPBlocks {
    ...
    public static final RegistryObject<Block> CHICKEN_OF_THE_CAVES = registerBlock("chicken_of_the_caves", () -> new MushroomBlock(OPBlockProperties.mushroom(MapColor.TERRACOTTA_YELLOW), TreeFeatures.HUGE_BROWN_MUSHROOM));
    ...
    public static final RegistryObject<Block> RAINCAP = registerBlock("raincap", () -> new MushroomBlock(OPBlockProperties.mushroom(MapColor.COLOR_PURPLE), TreeFeatures.HUGE_BROWN_MUSHROOM));
    ...
    public static final RegistryObject<Block> CAVE_PATTY = registerBlock("cave_patty", () -> new MushroomBlock(OPBlockProperties.mushroom(MapColor.COLOR_BROWN), TreeFeatures.HUGE_BROWN_MUSHROOM));
    ...
    public static final RegistryObject<Block> POWDER_GNOME = registerBlock("powder_gnome", () -> new MushroomBlock(OPBlockProperties.mushroom(MapColor.COLOR_RED), TreeFeatures.HUGE_BROWN_MUSHROOM));
    ...
    public static final RegistryObject<Block> CREAM_CAP = registerBlock("cream_cap", () -> new MushroomBlock(OPBlockProperties.mushroom(MapColor.TERRACOTTA_WHITE), TreeFeatures.HUGE_BROWN_MUSHROOM));
    ...
    public static final RegistryObject<Block> COPPER_ENOKI = registerBlock("copper_enoki", () -> new MushroomBlock(OPBlockProperties.mushroom(MapColor.COLOR_ORANGE), TreeFeatures.HUGE_BROWN_MUSHROOM));
    ...
    public static final RegistryObject<Block> BLUE_TRUMPET = registerBlock("blue_trumpet", () -> new MushroomBlock(OPBlockProperties.mushroom(MapColor.COLOR_BLUE), TreeFeatures.HUGE_BROWN_MUSHROOM));
    ...
    public static final RegistryObject<Block> PRINCESS_JELLY = registerBlock("princess_jelly", () -> new MushroomBlock(OPBlockProperties.mushroom(MapColor.COLOR_PURPLE), TreeFeatures.HUGE_BROWN_MUSHROOM));
    ...
    public static final RegistryObject<Block> BLACKCAP = registerBlock("blackcap", () -> new MushroomBlock(OPBlockProperties.mushroom(MapColor.COLOR_BLACK), TreeFeatures.HUGE_BROWN_MUSHROOM));
    ...
    public static final RegistryObject<Block> CAP_OF_EYE = registerBlock("cap_of_eye", () -> new MushroomBlock(OPBlockProperties.mushroom(MapColor.COLOR_PURPLE), TreeFeatures.HUGE_BROWN_MUSHROOM));
    ...
    public static final RegistryObject<Block> GREEN_FUNK = registerBlock("green_funk", () -> new MushroomBlock(OPBlockProperties.mushroom(MapColor.COLOR_GREEN), TreeFeatures.HUGE_BROWN_MUSHROOM));
    ...
    public static final RegistryObject<Block> LIME_NUB = registerBlock("lime_nub", () -> new MushroomBlock(OPBlockProperties.mushroom(MapColor.COLOR_LIGHT_GREEN), TreeFeatures.HUGE_BROWN_MUSHROOM));
    ...
    public static final RegistryObject<Block> POP_CAP = registerBlock("pop_cap", () -> new MushroomBlock(OPBlockProperties.mushroom(MapColor.COLOR_YELLOW), TreeFeatures.HUGE_BROWN_MUSHROOM));
    ...
    public static final RegistryObject<Block> PURPLE_KNOB = registerBlock("purple_knob", () -> new MushroomBlock(OPBlockProperties.mushroom(MapColor.COLOR_PURPLE), TreeFeatures.HUGE_BROWN_MUSHROOM));
    ...
    public static final RegistryObject<Block> QUEEN_IN_MAGENTA = registerBlock("queen_in_magenta", () -> new MushroomBlock(OPBlockProperties.mushroom(MapColor.COLOR_MAGENTA), TreeFeatures.HUGE_BROWN_MUSHROOM));
    ...
    public static final RegistryObject<Block> SLATESHROOM = registerBlock("slateshroom", () -> new MushroomBlock(OPBlockProperties.mushroom(MapColor.COLOR_PURPLE), TreeFeatures.HUGE_BROWN_MUSHROOM));
    ...
    public static final RegistryObject<Block> SLIPPERY_TOP = registerBlock("slippery_top", () -> new MushroomBlock(OPBlockProperties.mushroom(MapColor.COLOR_YELLOW), TreeFeatures.HUGE_BROWN_MUSHROOM));
    ...
    public static final RegistryObject<Block> WHITECAP = registerBlock("whitecap", () -> new MushroomBlock(OPBlockProperties.mushroom(MapColor.TERRACOTTA_WHITE), TreeFeatures.HUGE_BROWN_MUSHROOM));
