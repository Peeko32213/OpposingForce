...
import com.unusualmodding.opposing_force.entity.ai.util.helper.HitboxHelper;
...
public class TerrorEntity extends AbstractMonster implements GeoAnimatable, GeoEntity {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new TerrorEntity.RambleMeleeAttackGoal(this,  1.8F, true));
    }
    ...
    protected <E extends TerrorEntity> PlayState controller(final software.bernie.geckolib.core.animation.AnimationState<E> event) {
    ...
    static class RambleMeleeAttackGoal extends Goal {
        ...
        protected final TerrorEntity mob;
        ...
        public RambleMeleeAttackGoal(TerrorEntity p_i1636_1_, double p_i1636_2_, boolean p_i1636_4_) {
            this.mob = p_i1636_1_;
