...
public abstract class FrictionlessProjectile extends AbstractHurtingProjectile implements ItemSupplier {

    public double accelerationPower;

    protected FrictionlessProjectile(EntityType<? extends AbstractHurtingProjectile> entityType, Level level) {
    ...
    public FrictionlessProjectile(EntityType<? extends AbstractHurtingProjectile> entityType, double x, double y, double z, Vec3 movement, Level level) {
        this(entityType, level);
    ...
    public boolean canCollideWith(@NotNull Entity entity) {
        return !(entity instanceof FrictionlessProjectile) && super.canCollideWith(entity);
    }

    @Override
    protected boolean canHitEntity(@NotNull Entity target) {
        if (target instanceof FrictionlessProjectile) {
            return false;
        } else {
