...
public class Emeraldfish extends Monster {
    @Nullable
    private Emeraldfish.SilverfishWakeUpFriendsGoal friendsGoal;

    public Emeraldfish(EntityType<? extends Monster> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }

    protected void registerGoals() {
        this.friendsGoal = new Emeraldfish.SilverfishWakeUpFriendsGoal(this);
        this.goalSelector.addGoal(1, new FloatGoal(this));
        this.goalSelector.addGoal(1, new ClimbOnTopOfPowderSnowGoal(this, this.level()));
        this.goalSelector.addGoal(3, this.friendsGoal);
        this.goalSelector.addGoal(4, new MeleeAttackGoal(this, 1.0F, false));
        this.goalSelector.addGoal(5, new Emeraldfish.SilverfishMergeWithStoneGoal(this));
    ...
    public static boolean checkSilverfishSpawnRules(EntityType<Emeraldfish> pSilverfish, LevelAccessor pLevel, MobSpawnType pSpawnType, BlockPos pPos, RandomSource pRandom) {
    ...
    static class SilverfishMergeWithStoneGoal extends RandomStrollGoal {
        ...
        public SilverfishMergeWithStoneGoal(Emeraldfish pSilverfish) {
    ...
    static class SilverfishWakeUpFriendsGoal extends Goal {
        ...
        public SilverfishWakeUpFriendsGoal(Emeraldfish pSilverfish) {
