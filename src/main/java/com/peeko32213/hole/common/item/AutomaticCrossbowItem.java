...
public class AutomaticCrossbowItem extends ProjectileWeaponItem implements Vanishable {
    ...
    public AutomaticCrossbowItem(Item.Properties pProperties) {
        super(pProperties);
    }
    ...
    public static float getRandomShotPitch(boolean pIsHighPitched, RandomSource pRandom) {
