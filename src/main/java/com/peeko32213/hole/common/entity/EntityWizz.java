...
public class EntityWizz extends AbstractMonster implements FlyingAnimal, GeoAnimatable, GeoEntity {
    ...
    public static <T extends Mob> boolean canWhizzSpawn(EntityType<EntityWizz> entityType, ServerLevelAccessor iServerWorld, MobSpawnType reason, BlockPos pos, RandomSource random) {
