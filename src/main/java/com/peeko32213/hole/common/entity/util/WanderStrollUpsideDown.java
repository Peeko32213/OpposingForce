...
public class WanderStrollUpsideDown extends RandomStrollGoal {
    ...
    private final EntityPaleSpider spider;

    public WanderStrollUpsideDown(EntityPaleSpider spider, double speedModifier, int interval) {
    ...
    protected Vec3 getPosition() {
        if (spider.isUpsideDown()) {
            for (int i = 0; i < 15; i++) {
                ...
                BlockPos lowestPos = EntityPaleSpider.getLowestPos(spider.level(), randPos);
