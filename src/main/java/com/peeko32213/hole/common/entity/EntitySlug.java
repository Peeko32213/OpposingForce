...
import com.peeko32213.hole.common.entity.util.WallClimbingNavigation;
...
public class EntitySlug extends AbstractMonster implements GeoAnimatable, GeoEntity {
    ...
    private static final EntityDataAccessor<Byte> CLIMB_FLAG = SynchedEntityData.defineId(EntitySlug.class, EntityDataSerializers.BYTE);


    public EntitySlug(EntityType<? extends AbstractMonster> pEntityType, Level pLevel) {
    ...
    protected <E extends EntitySlug> PlayState controller(final software.bernie.geckolib.core.animation.AnimationState<E> event) {
    ...
    public static <T extends Mob> boolean canFirstTierSpawn(EntityType<EntitySlug> entityType, ServerLevelAccessor iServerWorld, MobSpawnType reason, BlockPos pos, RandomSource random) {
