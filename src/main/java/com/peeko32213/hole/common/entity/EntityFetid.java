...
public class EntityFetid extends AbstractMonster implements GeoAnimatable, GeoEntity {
    ...
    public EntityFetid(EntityType<? extends AbstractMonster> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new EntityFetid.FetidMeleeAttackGoal(this,  1.0F, true));
    ...
    protected <E extends EntityFetid> PlayState controller(final software.bernie.geckolib.core.animation.AnimationState<E> event) {
    ...
    static class FetidMeleeAttackGoal extends Goal {
        ...
        protected final EntityFetid mob;
        ...
        public FetidMeleeAttackGoal(EntityFetid p_i1636_1_, double p_i1636_2_, boolean p_i1636_4_) {
            this.mob = p_i1636_1_;
