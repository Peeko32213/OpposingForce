...
public class EntityFireSlime extends AbstractMonster implements GeoAnimatable, GeoEntity {
    private static final EntityDataAccessor<Boolean> DESPAWN_SOON = SynchedEntityData.defineId(EntityFireSlime.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Boolean> LAUNCHED = SynchedEntityData.defineId(EntityFireSlime.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Optional<UUID>> PARENT_UUID = SynchedEntityData.defineId(EntityFireSlime.class, EntityDataSerializers.OPTIONAL_UUID);
    ...
    public EntityFireSlime(EntityType<? extends EntityFireSlime> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.fixupDimensions();
        this.moveControl = new EntityFireSlime.FireSlimeMoveControl(this);
    }
    ...
    protected void registerGoals() {
        this.goalSelector.addGoal(1, new EntityFireSlime.FireSlimeFloatGoal(this));
        this.goalSelector.addGoal(2, new EntityFireSlime.FireSlimeAttackGoal(this));
        this.goalSelector.addGoal(3, new EntityFireSlime.FireSlimeRandomDirectionGoal(this));
        this.goalSelector.addGoal(5, new EntityFireSlime.FireSlimeKeepOnJumpingGoal(this));
    ...
    protected boolean canHitEntity(Entity p_230298_1_) {
        return !p_230298_1_.isSpectator() && !(p_230298_1_ instanceof EntityGuzzler);
    }
    ...
    static class FireSlimeFloatGoal extends Goal {
        private final EntityFireSlime slime;

        public FireSlimeFloatGoal(EntityFireSlime pSlime) {
            this.slime = pSlime;
        ...
        public boolean canUse() {
            return (this.slime.isInWater() || this.slime.isInLava()) && this.slime.getMoveControl() instanceof EntityFireSlime.FireSlimeMoveControl;
        }
        ...
        public void tick() {
            ...
            if (movecontrol instanceof EntityFireSlime.FireSlimeMoveControl slime$slimemovecontrol) {
    ...
    static class FireSlimeKeepOnJumpingGoal extends Goal {
        ...
        public FireSlimeKeepOnJumpingGoal(EntityFireSlime pSlime) {
            this.slime = pSlime;
            this.setFlags(EnumSet.of(Goal.Flag.JUMP, Goal.Flag.MOVE));
        }
    ...
    static class FireSlimeAttackGoal extends Goal {
        ...
        public FireSlimeAttackGoal(EntityFireSlime pSlime) {
            this.slime = pSlime;
        ...
        public boolean canUse() {
            ...
            if (livingentity == null) {
                ...
                return !this.slime.canAttack(livingentity) ? false : this.slime.getMoveControl() instanceof EntityFireSlime.FireSlimeMoveControl;
            }
        }
    ...
    private static class FireSlimeRandomDirectionGoal extends Goal {
        ...
        public FireSlimeRandomDirectionGoal(EntityFireSlime pSlime) {
            this.slime = pSlime;
            this.setFlags(EnumSet.of(Goal.Flag.LOOK));
        }
         ...
         */
        public boolean canUse() {
            return this.slime.getTarget() == null && (this.slime.onGround() || this.slime.isInWater() || this.slime.isInLava() || this.slime.hasEffect(MobEffects.LEVITATION)) && this.slime.getMoveControl() instanceof EntityFireSlime.FireSlimeMoveControl;
        }
    ...
    private static class FireSlimeMoveControl extends MoveControl {
        ...
        private final EntityFireSlime fireSlime;
        private boolean isAggressive;

        public FireSlimeMoveControl(EntityFireSlime fireSlime) {
            super(fireSlime);
    ...
    protected <E extends EntityFireSlime> PlayState controller(final software.bernie.geckolib.core.animation.AnimationState<E> event) {
